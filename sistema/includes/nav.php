<nav>
			...
			<?php  } ?>
				...
				<li class="principal">
					...
					<ul>
						<li><a href="lista_producto.php"><i class="fas fa-cubes"></i> Inventario</a></li>
						<?php 
				if ($_SESSION['rol'] == 1 || $_SESSION['rol'] == 2) {
				
				?>
						<li><a href="reabastecer_producto.php"><i class="fas fa-cart-plus"></i> Registrar Entrada</a></li>
